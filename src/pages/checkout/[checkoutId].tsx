...
export default function Checkout() {
  ...
  const CheckboxIcon = () => (
    <svg
      ...
      className="absolute bottom-1 right-1 h-6 w-6" // added positioning classes here
      fill="none"
      viewBox="0 0 24 24"
      stroke="currentColor"
    >
      ...
      forms.push(
        ...
        >
          ...
          <div className="grid grid-cols-3">
            <div className="flex">
              <input name="chsex" id={`male${i}`} type="radio" />
          ...
          <input className="w-full rounded-md border-2 p-2 text-green-500 hover:border-blue-200 focus:border-blue-400" />
          ...
          <input
            id={`email${i}`}
            type="email"
            className="w-full rounded-md border-2 p-2 text-green-500 hover:border-blue-200 focus:border-blue-400"
          />
  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-[#2e026d] to-[#15162c] p-5">
        ...
        <div className="mt-8 grid w-full items-center justify-items-center rounded-xl bg-white/10 p-5 md:w-1/2">
          ...
          <div className="flex w-1/2 flex-col items-center justify-center justify-items-center sm:flex-row">
            <div className="mt-3 flex w-full flex-col items-center justify-center justify-items-center text-lg text-green-500">
            ...
            <div className="mt-5  flex w-full flex-col items-center justify-center justify-items-center text-lg text-green-500">
        ...
        <div className="mt-20 grid w-full items-center justify-items-center rounded-xl bg-white/10 p-5 md:w-1/2">
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-5 gap-4">
            <button
              ...
              className="relative justify-center rounded-md text-green-500 bg-white px-4 py-2 font-bold hover:bg-slate-100" // added 'relative' class here
            >
              <div className="relative">
                {" "}
                <Image
                  src="/assets/gopay-logo.png"
                  alt="GoPay"
                  width={500}
                  height={500}
                  style={{
              ...
              {selectedPayment === "GoPay" && <CheckboxIcon />}
            </button>

            <button
              onClick={() => handlePayment("BCA")}
              className=" relative justify-center rounded-md  bg-white px-4 py-2 font-bold text-green-500 hover:bg-slate-100"
            >
              <div className="relative">
                {" "}
                <Image
              ...
              {selectedPayment === "BCA" && <CheckboxIcon />}
            </button>
            <button
              onClick={() => handlePayment("BNI")}
              className=" relative justify-center rounded-md  bg-white px-4 py-2 font-bold text-green-500 hover:bg-slate-100"
            >
              <div className="relative">
                {" "}
                <Image
                  src="/assets/BNI-logo.svg"
                  alt="BNI"
                  width={500}
                  height={500}
                  style={{
              ...
              {selectedPayment === "BNI" && <CheckboxIcon />}
            </button>
            <button
            ...
            >
              ...
              {selectedPayment === "VISA" && <CheckboxIcon />}
            </button>
            <button
            ...
            >
              ...
              {selectedPayment === "MASTERCARD" && <CheckboxIcon />}
            </button>
          </div>

          <button
            className="mt-5 rounded-md bg-blue-500 p-2 text-white hover:bg-blue-600"
            hidden={selectedPayment == "" || selectedPayment == null}
          >
            {" "}
